...
UBUNTU_TRANSLATION_DOMAIN="geocodemodel.liu-xiao-guo"
...
aptest.commands = bash $$PWD/geocodemodel/tests/autopilot/run
aptest.depends  = sub-geocodemodel

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/geocodemodel/tests/unit 
unittest.depends  = sub-geocodemodel
